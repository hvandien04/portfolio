        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <div className="text-left" data-aos="fade-right" data-aos-duration="1000">
            ...
            <div className="flex space-x-4">
              <a
                aria-label="Facebook"
                className="h-12 w-12 rounded-full bg-black flex items-center justify-center hover:bg-cyan-400"
                href="https://www.facebook.com/HoangVanDien.profile"
                target="_blank"
              ...
              <a
                aria-label="GitHub"
                className="h-12 w-12 rounded-full bg-black flex items-center justify-center hover:bg-cyan-400"
                href="https://github.com/hvandien04/"
                target="_blank"
                rel="noopener noreferrer"
              >
          ...
          <div data-aos="fade-left" data-aos-duration="1000">
            <form
              className="space-y-4 bg-white p-4 rounded-lg shadow-md text-left"
